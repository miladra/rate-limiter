package com.payconiq.stock.web.rest;
...
import com.payconiq.stock.utility.HeaderUtil;
import com.payconiq.stock.utility.PaginationUtil;
import com.payconiq.stock.utility.ResponseUtil;
...
/**
 * REST controller for managing {@link com.payconiq.stock.domain.Stock}.
 */
@RestController
@RequestMapping("/api")
